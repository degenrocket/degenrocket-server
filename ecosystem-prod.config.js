  ...
  apps: [
    {
      ...
      // otherwise bree jobs to fetch RSS/SPASM will be called multiple
      // times on multiple CPU cores.
      // TODO: find a better solution, e.g. centralize the fetching job
      // to a single instance or a separate service.
